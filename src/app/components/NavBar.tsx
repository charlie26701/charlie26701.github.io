	...
	return (
		<>
			<li className="scroll-link mb-1 mt-4 sm:my-0 sm:mr-4">
				...
				>
					關於我
					<span className="block h-[1px] max-w-0 bg-neutral-700 transition-all duration-500 group-hover:max-w-full dark:bg-white"></span>
				</Link>
			</li>
...
export default function NavBar() {
	...
	return (
		<>
			<nav
				className="sticky top-0 z-10 w-full border-b-2 border-cyan-400 bg-cyan-100 px-8 py-8 transition-all ease-in-out dark:border-0 dark:bg-neutral-800 md:fixed"
				id="horizontal-navbar"
			>
				<div className="flex w-full items-center justify-between">
					<button
						onClick={() => animateScroll.scrollToTop()}
						className="group text-lg text-neutral-700 transition duration-300 dark:text-white sm:text-xl"
					>
						Charlie. BLOG
						<span className="block h-0.5 max-w-0 bg-neutral-700 transition-all duration-500 group-hover:max-w-full dark:bg-white"></span>
					</button>
					<div className="flex">
						<AiOutlineMenu
